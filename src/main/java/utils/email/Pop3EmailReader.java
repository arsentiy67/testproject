...
/*
  ...
  for the iii.automation@gmail.com account to allow this class to load emails via POP3
  ...
  Use it like this:
      ...
      List<OfflineMessage> messages = r.getMessagesBy("sender@iii-conv.com", Date.from(newerThan));
