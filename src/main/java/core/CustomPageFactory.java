...
public class CustomPageFactory {
  ...
  private static void initElement(WebDriver driver, Field field, Object section) {
    try {
      ...
      if (instance != null) {
        ...
        if (isClass(type, iWebElement.class) || isClass(type, iElementsList.class)) {
  ...
  private static Object newInstance(WebDriver driver, Field field) {
    if (isClass(field, iElementsList.class) || isList(field)) {
      return new iElementsList(driver, field.getName());
    }
